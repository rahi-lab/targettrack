...
class Net(nn.Module):
    def __init__(self, n_channels=3,kernel_size=3,num_classes=10):
        ...
        # First convolution
        self.conv1=nn.Conv3d(n_channels, 32, kernel_size=3, stride=1,padding=1,bias=False)
        ...
        self.conv10=nn.Conv3d(256,256, kernel_size=3, stride=1,padding=1,bias=False)
        self.norm10=nn.BatchNorm3d(256)
        self.upconv2=nn.ConvTranspose3d(256,256,kernel_size=2,stride=2)

        self.conv11=nn.Conv3d(384,128, kernel_size=3, stride=1,padding=1,bias=False)
        self.norm11=nn.BatchNorm3d(128)
        self.conv12=nn.Conv3d(128,128, kernel_size=3, stride=1,padding=1,bias=False)
        self.norm12=nn.BatchNorm3d(128)
        self.upconv3=nn.ConvTranspose3d(128,128,kernel_size=2,stride=2)

        self.conv13=nn.Conv3d(192,128, kernel_size=3, stride=1,padding=1,bias=False)
